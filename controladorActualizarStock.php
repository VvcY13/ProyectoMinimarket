...
$conexion = conectar();
$sqlNuevaCompra = "INSERT INTO compras (FechaCompra, Estado) VALUES (NOW(), 'pendiente')";
...
if (isset($data['total'])) {
    ...
    // Insertar nueva compra en la tabla 'compras' con el total recibido
    ...
    // Operaciones adicionales si es necesario con el total de la compra
} else {
